...
const ExperienceLogs = ({ isActive }) => {
  return (
    <div className="h-full flex flex-col relative">
      ...
      <div className="flex items-center gap-2 mb-2 sm:mb-4 text-hud-primary font-mono text-xs sm:text-sm relative z-10">
      ...
      <div className="flex-1 flex gap-2 sm:gap-4 overflow-x-auto pb-2 relative z-10 scrollbar-thin justify-center">
      ...
      <motion.div 
        className="mt-2 sm:mt-4 text-xs font-mono text-hud-primary border-t border-hud-border pt-2 sm:pt-3 relative z-10 flex items-center gap-2 sm:gap-4"
